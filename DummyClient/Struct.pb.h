...
class BuffDataA final :
 ...
 public:
  ...
  BuffDataA* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline uint64_t BuffDataA::_internal_buffid() const {
  return buffid_;
}
inline uint64_t BuffDataA::buffid() const {
  // @@protoc_insertion_point(field_get:Protocol.BuffDataA.buffId)
  return _internal_buffid();
}
inline void BuffDataA::_internal_set_buffid(uint64_t value) {
  
  buffid_ = value;
}
inline void BuffDataA::set_buffid(uint64_t value) {
  _internal_set_buffid(value);
...
inline uint64_t BuffDataA::_internal_victims(int index) const {
  return victims_.Get(index);
}
inline uint64_t BuffDataA::victims(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.BuffDataA.victims)
  return _internal_victims(index);
}
inline void BuffDataA::set_victims(int index, uint64_t value) {
  victims_.Set(index, value);
  // @@protoc_insertion_point(field_set:Protocol.BuffDataA.victims)
}
inline void BuffDataA::_internal_add_victims(uint64_t value) {
  victims_.Add(value);
}
inline void BuffDataA::add_victims(uint64_t value) {
  _internal_add_victims(value);
