...
class BuffDataA;
struct BuffDataADefaultTypeInternal;
extern BuffDataADefaultTypeInternal _BuffDataA_default_instance_;
}  // namespace Protocol
PROTOBUF_NAMESPACE_OPEN
template<> ::Protocol::BuffData* Arena::CreateMaybeMessage<::Protocol::BuffData>(Arena*);
template<> ::Protocol::BuffDataA* Arena::CreateMaybeMessage<::Protocol::BuffDataA>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Protocol {
...
class BuffDataA final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protocol.BuffDataA) */ {
 public:
  inline BuffDataA() : BuffDataA(nullptr) {}
  ~BuffDataA() override;
  explicit constexpr BuffDataA(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  BuffDataA(const BuffDataA& from);
  BuffDataA(BuffDataA&& from) noexcept
    : BuffDataA() {
    *this = ::std::move(from);
  }

  inline BuffDataA& operator=(const BuffDataA& from) {
    CopyFrom(from);
    return *this;
  }
  inline BuffDataA& operator=(BuffDataA&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const BuffDataA& default_instance() {
    return *internal_default_instance();
  }
  static inline const BuffDataA* internal_default_instance() {
    return reinterpret_cast<const BuffDataA*>(
               &_BuffDataA_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(BuffDataA& a, BuffDataA& b) {
    a.Swap(&b);
  }
  inline void Swap(BuffDataA* other) {
    if (other == this) return;
    if (GetOwningArena() == other->GetOwningArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(BuffDataA* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  inline BuffDataA* New() const final {
    return new BuffDataA();
  }

  BuffDataA* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<BuffDataA>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const BuffDataA& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const BuffDataA& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(BuffDataA* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.BuffDataA";
  }
  protected:
  explicit BuffDataA(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  // @@protoc_insertion_point(class_scope:Protocol.BuffDataA)
 private:
  class _Internal;
...
// uint64 buffId = 1;
inline void BuffDataA::clear_buffid() {
  buffid_ = uint64_t{0u};
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 BuffDataA::_internal_buffid() const {
  return buffid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 BuffDataA::buffid() const {
  // @@protoc_insertion_point(field_get:Protocol.BuffDataA.buffId)
  return _internal_buffid();
}
inline void BuffDataA::_internal_set_buffid(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  buffid_ = value;
}
inline void BuffDataA::set_buffid(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_buffid(value);
  // @@protoc_insertion_point(field_set:Protocol.BuffDataA.buffId)
}

// float remainTime = 2;
inline void BuffDataA::clear_remaintime() {
  remaintime_ = 0;
}
inline float BuffDataA::_internal_remaintime() const {
  return remaintime_;
}
inline float BuffDataA::remaintime() const {
  // @@protoc_insertion_point(field_get:Protocol.BuffDataA.remainTime)
  return _internal_remaintime();
}
inline void BuffDataA::_internal_set_remaintime(float value) {
  
  remaintime_ = value;
}
inline void BuffDataA::set_remaintime(float value) {
  _internal_set_remaintime(value);
  // @@protoc_insertion_point(field_set:Protocol.BuffDataA.remainTime)
}

// repeated uint64 victims = 3;
inline int BuffDataA::_internal_victims_size() const {
  return victims_.size();
}
inline int BuffDataA::victims_size() const {
  return _internal_victims_size();
}
inline void BuffDataA::clear_victims() {
  victims_.Clear();
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 BuffDataA::_internal_victims(int index) const {
  return victims_.Get(index);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 BuffDataA::victims(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.BuffDataA.victims)
  return _internal_victims(index);
}
inline void BuffDataA::set_victims(int index, ::PROTOBUF_NAMESPACE_ID::uint64 value) {
  victims_.Set(index, value);
  // @@protoc_insertion_point(field_set:Protocol.BuffDataA.victims)
}
inline void BuffDataA::_internal_add_victims(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  victims_.Add(value);
}
inline void BuffDataA::add_victims(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_add_victims(value);
  // @@protoc_insertion_point(field_add:Protocol.BuffDataA.victims)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::uint64 >&
BuffDataA::_internal_victims() const {
  return victims_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::uint64 >&
BuffDataA::victims() const {
  // @@protoc_insertion_point(field_list:Protocol.BuffDataA.victims)
  return _internal_victims();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::uint64 >*
BuffDataA::_internal_mutable_victims() {
  return &victims_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::uint64 >*
BuffDataA::mutable_victims() {
  // @@protoc_insertion_point(field_mutable_list:Protocol.BuffDataA.victims)
  return _internal_mutable_victims();
}
